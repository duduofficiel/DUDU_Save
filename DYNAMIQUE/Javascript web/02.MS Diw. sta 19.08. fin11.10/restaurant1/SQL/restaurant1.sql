-- Supprime la base de données si elle existe - თუ მონაცემთა ბაზა არსებობს, წაშალე იგი.
DROP DATABASE IF EXISTS restaurant;

-- Création de la base de données - მონაცემთა ბაზის შექმნა.
CREATE DATABASE restaurant;

-- Sélection de la base - ბაზის არჩევა.
USE restaurant;

-- Création de la table client - კლიენტის ცხრილის შექმნა.
CREATE TABLE client (
...
-- Création de la table commande - შეკვეთების ცხრილის შექმნა.
...
-- Création de la table categorie - კატეგორიის ცხრილის შექმნა.
CREATE TABLE categorie (
    id_categorie INT PRIMARY KEY NOT NULL AUTO_INCREMENT, 
    nom_categorie VARCHAR(50)
);

-- Création de la table plat ნივთის ცხრილის შექმნა.
CREATE TABLE plat (
...
-- Données pour la table `client - მონაცემები ცხრილისთვის.
...
-- Données pour la table `categorie - მონაცემები ცხრილისთვის კატეგორია.
...
-- Données pour la table `plat - მონაცემები ცხრილისთვის.
...
-- Données pour la table `commande - მონაცემები ცხრილისთვის.
